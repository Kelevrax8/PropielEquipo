...
try {
    ...
    // Obtener pacientes únicos que han tenido citas de tamizaje con este doctor
    $pacientes_tamizaje = [];
    ...
    try {
        ...
        $pacientes_tamizaje = array_values($pacientes_unicos);
        
        // Ordenar por última cita más reciente
        usort($pacientes_tamizaje, function($a, $b) {
            return strtotime($b['ultima_cita']) - strtotime($a['ultima_cita']);
        });
        
    } catch (Exception $e) {
        error_log("Error obteniendo pacientes de tamizaje: " . $e->getMessage());
    }
    
} catch (Exception $e) {
    error_log("Error en pacientes tamizaje: " . $e->getMessage());
    header('location: ../../../Landing/login.html');
    exit();
}
?>
...
<head>
    ...
    <title>Pacientes Tamizaje - PropielEquipo</title>
...
<body class="bg-gradient-to-r from-purple-50 to-purple-100 flex flex-col min-h-screen">
    ...
    <!-- Header de Pacientes de Tamizaje -->
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600"><?php echo count($pacientes_tamizaje); ?></p>
                    </div>
                    <ion-icon name="people-outline" class="text-3xl text-purple-500"></ion-icon>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600">
                            <?php 
                            $pacientes_activos = array_filter($pacientes_tamizaje, function($paciente) {
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600">
                            ...
                            if (count($pacientes_tamizaje) > 0) {
                                ...
                                echo round($total_citas / count($pacientes_tamizaje), 1);
                            } else {
                                echo '0';
                            }
                            ?>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="bg-purple-600 text-white p-6">
                <h2 class="text-xl font-bold flex items-center">
                    ...
                    Todos los Pacientes de Tamizaje
                </h2>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if (count($pacientes_tamizaje) > 0): ?>
                            <?php foreach ($pacientes_tamizaje as $paciente): ?>
                                <?php 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">Paciente de tamizaje</div>
                                            </div>
                                        </div>
                                    </td>
