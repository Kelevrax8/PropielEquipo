        ...
        <div class="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-6 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-purple-200 text-sm">Gestión de citas de tamizaje</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="bg-purple-600 text-white p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <!-- Week Navigator -->
                    <div class="flex items-center gap-2 bg-purple-700 rounded-lg px-4 py-2">
                        <button onclick="changeWeek(-1)" class="text-white hover:text-purple-200 transition">
                        ...
                        <button onclick="goToToday()" class="ml-2 text-white hover:text-purple-200 transition text-sm underline">
                            Hoy
                        </button>
                    </div>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-b flex gap-2">
                <button onclick="setViewMode('week')" id="week-view-btn" class="px-4 py-2 rounded-lg text-sm font-medium transition bg-purple-600 text-white">
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200" id="pagination-info">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        Mostrando <span id="showing-start">0</span> a <span id="showing-end">0</span> de <span id="total-appointments"><?php echo count($citas_tamizaje); ?></span> citas
                    </div>
        ...
        <div class="flex-1 overflow-y-auto p-4 sm:p-6">
            ...
            <div class="mb-4 sm:mb-6">
                <label for="observations-textarea" class="block text-sm font-semibold text-gray-700 mb-2">
                    <ion-icon name="clipboard" class="mr-2 text-purple-600"></ion-icon>
...
<script>
    ...
    const allAppointments = <?php echo json_encode($citas_tamizaje); ?>;
    ...
    function setViewMode(mode) {
        ...
        if (mode === 'week') {
            weekBtn.className = 'px-4 py-2 rounded-lg text-sm font-medium transition bg-purple-600 text-white';
            ...
            allBtn.className = 'px-4 py-2 rounded-lg text-sm font-medium transition bg-purple-600 text-white';
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div class="flex items-start gap-4 flex-1">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="bg-purple-100 text-blue-800 font-bold text-lg px-3 py-2 rounded-lg text-center min-w-[70px]">
                                        ${cita.horario}
                                    </div>
                                </div>
                            ...
                            <div class="flex-shrink-0">
                                <button onclick="openObservationsModal(${cita.id_cita})" 
                                        class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm transition duration-200 flex items-center w-full lg:w-auto justify-center">
            ...
            if (i === 1 || i === totalPages || (i >= currentPage - 1 && i <= currentPage + 1)) {
                buttons.push(`
                    <button onclick="changePage(${i})" 
                            class="px-3 py-1 rounded text-sm ${i === currentPage ? 'bg-purple-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border'}">
                        ${i}
                    </button>
                `);
