<?php
// Dashboard específico para Dermatología
session_start();
...
try {
    ...
    // Obtener estadísticas específicas de dermatología para este doctor
    $citas_derma_hoy = [];
    $imagenes_derma = [];
    
    try {
        // Filtrar citas de dermatología de hoy asignadas a este doctor
        ...
        foreach ($todas_citas as $cita) {
            if (strtolower($cita['servicio']) === 'dermatología') {
                $citas_derma_hoy[] = $cita;
            }
        }
        
        // Obtener imágenes médicas de dermatología
        $todas_imagenes = $db_queries->getDoctorPatientImages($uid);
        foreach ($todas_imagenes as $imagen) {
            if ($imagen['tipo_imagen'] === 'dermatologia') {
                $imagenes_derma[] = $imagen;
            }
        }
        
    } catch (Exception $e) {
        error_log("Error obteniendo datos de dermatología: " . $e->getMessage());
    }
    
} catch (Exception $e) {
    error_log("Error en dashboard dermatología: " . $e->getMessage());
    header('location: ../../../Landing/login.html');
    exit();
}
?>
...
<head>
    ...
    <title>Dashboard Dermatología - PropielEquipo</title>
...
<body class="bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col min-h-screen">
    ...
    <!-- Dashboard Específico de Dermatología -->
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Dashboard de Dermatología</h1>
                    <p class="text-blue-100">Dr. <?php echo htmlspecialchars($nombre . " " . $apellido); ?></p>
                    <p class="text-blue-200 text-sm">Especialista en piel y enfermedades cutáneas</p>
                </div>
                <div class="hidden md:block">
                    <ion-icon name="medical" class="text-6xl opacity-30"></ion-icon>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600"><?php echo count($citas_derma_hoy); ?></p>
                    </div>
                    <ion-icon name="calendar" class="text-3xl text-blue-500"></ion-icon>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo count($imagenes_derma); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-800">Dermatología</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-blue-600 text-white p-4">
                    <h3 class="text-lg font-bold flex items-center">
                        ...
                        Citas de Dermatología Hoy
                    </h3>
                </div>
                <div class="p-6">
                    <?php if (count($citas_derma_hoy) > 0): ?>
                        <div class="space-y-3">
                            <?php foreach ($citas_derma_hoy as $cita): ?>
                        ...
                        <div class="mt-4">
                            <a href="citas_dermatologia.php" class="text-blue-600 hover:text-blue-700 font-medium">
                                Ver todas las citas →
                            </a>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">No hay citas de dermatología programadas para hoy</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-green-600 text-white p-4">
                    <h3 class="text-lg font-bold flex items-center">
                        ...
                        Imágenes Dermatológicas Recientes
                    </h3>
                </div>
                <div class="p-6">
                    <?php if (count($imagenes_derma) > 0): ?>
                        <div class="grid grid-cols-3 gap-3">
                            <?php 
                            $imagenes_recientes = array_slice($imagenes_derma, 0, 6);
                            ...
                            ?>
                                <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden relative">
                                    ...
                                    <!-- Overlay con gradiente y efecto hover como en imagenes_dermatologia.php -->
                        ...
                        <div class="mt-4">
                            <a href="imagenes_dermatologia.php" class="text-green-600 hover:text-green-700 font-medium">
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">No hay imágenes dermatológicas disponibles</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid md:grid-cols-4 gap-4">
                ...
                <a href="pacientes_dermatologia.php" class="flex flex-col items-center p-4 bg-green-50 hover:bg-green-100 rounded-lg transition duration-200">
