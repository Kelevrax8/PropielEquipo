...
try {
    ...
    // Verificar que el doctor tenga la especialidad de Dermatología (id_especialidad = 1)
    $especialidades_ids = array_column($_SESSION['especialidades'], 'id_especialidad');
    if (!in_array(1, $especialidades_ids)) {
        header('location: ../dashboard_dermatologia.php');
        exit();
    }
    ...
    $query = "SELECT c.*, 
              ...
              AND LOWER(c.servicio) = 'dermatología'
    ...
    error_log("Error en verificar pagos dermatología: " . $e->getMessage());
    header('location: ../../../../Landing/login.html');
    exit();
}
?>
...
<head>
    ...
    <title>Verificar Pagos - Dermatología - PropielEquipo</title>
...
<body class="bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Verificación de Pagos - Dermatología</h1>
                    <p class="text-blue-100">Dr. <?php echo htmlspecialchars($nombre . " " . $apellido); ?></p>
                    <p class="text-blue-200 text-sm">Revisa y aprueba comprobantes de pago</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-blue-100 rounded-full p-4">
                        <ion-icon name="cash" class="text-blue-600 text-3xl"></ion-icon>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-blue-100 rounded-full p-4">
                        <ion-icon name="checkmark-done" class="text-blue-600 text-3xl"></ion-icon>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div>
                                    <div class="flex items-center mb-4">
                                        <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                                            <ion-icon name="person" class="text-blue-600 text-2xl"></ion-icon>
                                        </div>
                                        <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <div class="flex items-center">
                                            <ion-icon name="medical" class="text-gray-400 mr-2"></ion-icon>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <?php for ($i = 1; $i <= $total_pages_pendientes; $i++): ?>
                                <a href="?page_pendientes=<?php echo $i; ?>" 
                                   class="px-4 py-2 rounded-lg transition <?php echo $i === $page_pendientes ? 'bg-blue-600 text-white font-bold' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'; ?>">
                                    <?php echo $i; ?>
                                </a>
                            <?php endfor; ?>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <?php for ($i = 1; $i <= $total_pages_sin_comprobante; $i++): ?>
                            <a href="?page_sin_comprobante=<?php echo $i; ?>" 
                               class="px-4 py-2 rounded-lg transition <?php echo $i === $page_sin_comprobante ? 'bg-blue-600 text-white font-bold' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'; ?>">
                                <?php echo $i; ?>
                            </a>
                        <?php endfor; ?>
    ...
    <script>
        function verificarPago(idCita, accion) {
            ...
            if (confirm(mensaje)) {
                window.location.href = '../../php_action/verificar_pago.php?id_cita=' + idCita + '&accion=' + accion + '&especialidad=dermatologia';
            }
        }
