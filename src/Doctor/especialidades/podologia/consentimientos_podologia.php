<?php
// Consentimientos informados para Podología
session_start();
...
try {
    ...
    error_log("Error en consentimientos podología: " . $e->getMessage());
    header('location: ../../../Landing/login.html');
    exit();
}
...
<head>
    ...
    <title>Consentimientos Informados - Podología</title>
...
<body class="bg-gradient-to-r from-emerald-50 to-emerald-100 flex flex-col min-h-screen">
        ...
        <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-2xl p-6 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-200 text-sm">Documentos legales firmados por los pacientes</p>
                </div>
                ...
                <div class="flex-1">
                    <div class="relative">
                        <input type="text" 
                               ...
                               class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                               autocomplete="off">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-emerald-600"><?php echo count($consentimientos_all); ?></p>
                        <?php if (!empty($search_term)): ?>
                        <p class="text-xs text-gray-500 mt-1">Mostrando: <?php echo $total_records; ?></p>
                        <?php endif; ?>
                    </div>
                    <ion-icon name="documents" class="text-3xl text-emerald-500"></ion-icon>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    ...
                    <ion-icon name="folder" class="text-3xl text-emerald-500"></ion-icon>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    ...
                    <ion-icon name="time" class="text-3xl text-emerald-500"></ion-icon>
                </div>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-emerald-100 rounded-full flex items-center justify-center">
                                            <ion-icon name="person" class="text-emerald-600 text-xl"></ion-icon>
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <button onclick="viewPDF('<?php echo htmlspecialchars($consent['filename']); ?>')" 
                                            class="text-emerald-600 hover:text-emerald-900 mr-3 inline-flex items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        ?>
                            <a href="?page=<?php echo $i; ?><?php echo !empty($search_term) ? '&search=' . urlencode($search_term) : ''; ?>" 
                               class="px-4 py-2 rounded-lg transition duration-200 <?php echo $i === $page ? 'bg-emerald-600 text-white font-bold' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'; ?>">
                                <?php echo $i; ?>
                            </a>
                        <?php endfor; ?>
    ...
    <div id="pdf-modal" class="fixed inset-0 bg-black bg-opacity-75 items-center justify-center z-50 hidden p-4">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-6xl h-[90vh] overflow-hidden flex flex-col">
            <!-- Header del Modal -->
            <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white p-4 flex items-center justify-between">
                <div class="flex items-center">
            ...
            <div class="border-t bg-gray-50 px-4 py-3 flex justify-end space-x-3">
                ...
                <button id="download-link" onclick="return false;"
                        class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition duration-200 inline-flex items-center">
