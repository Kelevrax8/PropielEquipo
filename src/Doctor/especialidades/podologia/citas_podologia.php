            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if (count($citas_podologia) > 0): ?>
                            <?php foreach ($citas_podologia as $cita): ?>
                                <?php 
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[95vh] flex flex-col">
        ...
        <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white p-4 sm:p-6 flex-shrink-0 rounded-t-lg">
            <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    <h2 class="text-lg sm:text-xl font-bold truncate">Observaciones Podológicas</h2>
        ...
        <div class="flex-1 overflow-y-auto p-4 sm:p-6">
            ...
            <div class="bg-emerald-50 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3">Información de la Cita Podológica</h3>
            ...
            <div class="mb-4 sm:mb-6">
                <label for="observations-textarea" class="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    Observaciones y Diagnóstico Podológico
                </label>
                <textarea 
                    id="observations-textarea" 
                    rows="6"
                    placeholder="Escriba aquí las observaciones podológicas, diagnóstico de patologías del pie, tratamiento recomendado, evolución, medicamentos, etc..."
                ...
                <p class="text-xs sm:text-sm text-gray-500 mt-1">
                    ...
                    Incluya información sobre patologías del pie, tratamientos podológicos, medicamentos y recomendaciones específicas para el cuidado de los pies.
