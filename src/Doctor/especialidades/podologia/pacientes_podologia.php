...
try {
    ...
    // Obtener pacientes únicos que han tenido citas de podología con este doctor
    $pacientes_podologia = [];
    ...
    try {
        ...
        $pacientes_podologia = array_values($pacientes_unicos);
        
        // Ordenar por última cita más reciente
        usort($pacientes_podologia, function($a, $b) {
            return strtotime($b['ultima_cita']) - strtotime($a['ultima_cita']);
        });
        
    } catch (Exception $e) {
        error_log("Error obteniendo pacientes de podología: " . $e->getMessage());
    }
    
} catch (Exception $e) {
    error_log("Error en pacientes podología: " . $e->getMessage());
    header('location: ../../../Landing/login.html');
    exit();
}
?>
...
<head>
    ...
    <title>Pacientes Podología - PropielEquipo</title>
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-emerald-600"><?php echo count($pacientes_podologia); ?></p>
                    </div>
                    <ion-icon name="people-outline" class="text-3xl text-emerald-500"></ion-icon>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600">
                            <?php 
                            $pacientes_activos = array_filter($pacientes_podologia, function($paciente) {
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600">
                            <?php 
                            if (count($pacientes_podologia) > 0) {
                                $total_citas = array_sum(array_column($pacientes_podologia, 'total_citas'));
                                echo round($total_citas / count($pacientes_podologia), 1);
                            } else {
                                echo '0';
                            }
                            ?>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="bg-emerald-600 text-white p-6">
                <h2 class="text-xl font-bold flex items-center">
                    ...
                    Todos los Pacientes de Podología
                </h2>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if (count($pacientes_podologia) > 0): ?>
                            <?php foreach ($pacientes_podologia as $paciente): ?>
                                <?php 
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 w-10 h-10">
                                                <div class="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center">
                                                    <ion-icon name="person" class="text-emerald-600"></ion-icon>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">Paciente podológico</div>
                                            </div>
                                        </div>
                                    </td>
